...
void kernel_main()
{
	...
	term_print("Welcome to LettOS!\n");
	term_print("Affectionately developed by Jackson Darman\n");
	term_print("Name idea by Wesley Keister\n");
	term_print("What would you like to do?\n");
}
